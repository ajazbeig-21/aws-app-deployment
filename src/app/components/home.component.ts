          ...
          <div class="text-center lg:text-left">
            <div class="flex justify-center lg:justify-start mb-6">
              <img src="assets/images/ajaz-profile-pic.png" 
                   ...
                   alt="Ajaz Beig - Software Engineer | DevOps & SRE Specialist" />
            </div>
            ...
            <p class="text-xl lg:text-2xl text-gray-600 mb-6 font-light">
              Software Engineer | DevOps & SRE Specialist
            </p>
            
            <p class="text-lg text-gray-700 mb-8 leading-relaxed">
              Building scalable infrastructures and automation solutions. 
              Expert in CI/CD, Docker, Kubernetes, AWS, and system reliability engineering.
            </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div class="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p class="text-gray-600 mb-4">
              Scalable infrastructure solutions with CI/CD pipelines, container orchestration, and cloud automation.
            </p>
